...
export const SmoothieCard: React.FC<SmoothieCardProps> = ({ product }) => {
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-softer hover:shadow-soft transition-shadow">
      <div className="bg-gradient-to-br from-pink-300 to-brand-forest-light h-40 flex items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-black/5" />
        <div className="text-center text-white z-10">
          <p className="text-sm opacity-80">🥤</p>
          <p className="text-sm opacity-80 mt-2">Product Image</p>
        </div>
      </div>

      <div className="p-4">
        <h3 className="font-bold text-brand-forest mb-3 text-lg">{product.name}</h3>
